-- schema_v3.sql (corrected to match live code in sqlite_backend.cpp)
--
-- The v3 storage schema: turns / summaries / decisions /
...
BEGIN
    INSERT INTO documents_fts(documents_fts, rowid, title, text, tags)
    VALUES ('delete', old.decision_id, old.title, old.text, old.tags);
    INSERT INTO documents_fts(rowid, title, text, tags)
    VALUES (new.document_id, new.title, new.text, new.tags);
END;
