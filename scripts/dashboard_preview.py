...
SCHEMA = [
    ...
    ("fts_w_unigram", "search", "FTS Unigram Weight", "float", "live", "0.3", "",
     "TF-IDF weight for single-word (unigram) matches in the custom text index."),
    ("fts_w_bigram", "search", "FTS Bigram Weight", "float", "live", "0.7", "",
     "TF-IDF weight for adjacent-word-pair (bigram) matches in the custom text index."),
    ("fts_w_metaphone", "search", "FTS Metaphone Weight", "float", "live", "1", "",
     "Weight for phonetic (Double Metaphone) matches relative to exact literal matches. 0 disables phonetic matching."),
    ("fts_literal_enabled", "search", "FTS Literal Enabled", "boolean", "live", "true", "",
     "Enable exact stemmed-literal term matching. Disable for DMP-only (phonetic-only) scoring."),
